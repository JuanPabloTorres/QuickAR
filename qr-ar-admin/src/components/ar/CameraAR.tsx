      ...
      >
        ...
        <div className="absolute top-1/2 right-4 transform -translate-y-1/2 pointer-events-auto">
          <button
            ...
            className="bg-black/50 backdrop-blur-sm text-white w-12 h-12 rounded-full flex items-center justify-center"
            aria-label={showOverlay ? "Ocultar controles" : "Mostrar controles"}
          >
        ...
        <div className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none">
          <div className="bg-black/40 backdrop-blur-sm text-white text-center p-4 rounded-lg max-w-xs">
            ...
            <div className="text-sm">
              Mueve el dispositivo para ver el contenido en AR
            </div>
            {experience.assets.length > 1 && (
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="w-full h-full border border-sky-400/20">
          ...
          <div className="absolute inset-0">
            <div className="absolute h-full w-px bg-sky-400/10 left-1/5" />
            <div className="absolute h-full w-px bg-sky-400/10 left-2/5" />
            <div className="absolute h-full w-px bg-sky-400/10 left-3/5" />
            <div className="absolute h-full w-px bg-sky-400/10 left-4/5" />

            <div className="absolute w-full h-px bg-sky-400/10 top-1/5" />
            <div className="absolute w-full h-px bg-sky-400/10 top-2/5" />
            <div className="absolute w-full h-px bg-sky-400/10 top-3/5" />
            <div className="absolute w-full h-px bg-sky-400/10 top-4/5" />
          </div>
        </div>
      </div>
    </div>

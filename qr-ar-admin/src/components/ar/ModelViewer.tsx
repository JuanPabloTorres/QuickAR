            ...
            try {
              ...
              const errorMessage =
                permissionError instanceof Error
                  ...
                  : "Permission denied";
              console.warn("⚠️ WebXR permissions restricted:", errorMessage);
              console.log(
                "📱 Falling back to Scene Viewer/Quick Look AR modes"
              );
            }
          } else {
            console.log(
              "ℹ️ WebXR not available, using Scene Viewer/Quick Look AR"
            );
          }

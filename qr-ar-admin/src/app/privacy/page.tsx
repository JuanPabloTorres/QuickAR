      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <FuturisticCardContent className="p-6">
              <div className="prose prose-invert max-w-none">
                <p className="text-slate-300 font-manrope leading-relaxed">
                  En QuickAR, respetamos tu privacidad y nos comprometemos a
                  proteger tu información personal. Esta Política de Privacidad
                  describe cómo recopilamos, usamos, almacenamos y compartimos
                  tu información cuando utilizas nuestra plataforma de realidad
                  aumentada.
                </p>
                <p className="text-slate-300 font-manrope leading-relaxed mt-4">
                  Al usar QuickAR, aceptas las prácticas descritas en esta
                  política. Si no estás de acuerdo con algún aspecto de esta
                  política, te recomendamos que no uses nuestros servicios.
                </p>
              </div>
            </FuturisticCardContent>
          </FuturisticCard>
          ...
          <FuturisticCard variant="glass">
            ...
            <FuturisticCardContent>
              <div className="space-y-4">
                <p className="text-slate-300 font-manrope leading-relaxed">
                  QuickAR cumple con el Reglamento General de Protección de
                  Datos (GDPR) de la Unión Europea y otras regulaciones de
                  privacidad aplicables a nivel internacional.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="font-medium font-manrope text-green-400">
                        Base Legal
                      </span>
                    </div>
                    <p className="text-sm text-green-300 font-manrope">
                      Procesamos datos basándose en consentimiento legítimo y
                  ...
                  <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
                    <div className="flex items-center mb-2">
                      ...
                      <span className="font-medium font-manrope text-blue-400">
                        Transferencias
                      </span>
                    </div>
                    <p className="text-sm text-blue-300 font-manrope">
                      Todas las transferencias internacionales usan mecanismos
            ...
            <FuturisticCardContent>
              <div className="space-y-4">
                <p className="text-slate-300 font-manrope leading-relaxed">
                  ...
                  ejercer tus derechos de datos, puedes contactarnos a través de
                ...
                <p className="text-slate-300 font-manrope leading-relaxed">
                  ...
                  ocasionalmente. Te notificaremos de cambios significativos por
                  correo electrónico o mediante un aviso prominente en nuestra
                  plataforma.
                </p>
              </div>
            </FuturisticCardContent>
        ...
        <div className="space-y-6">
          ...
          <FuturisticCard variant="default">
            <FuturisticCardHeader>
              <FuturisticCardTitle>Enlaces Rápidos</FuturisticCardTitle>
            </FuturisticCardHeader>
          ...
          <FuturisticCard variant="neon">
            <FuturisticCardHeader>
              <FuturisticCardTitle>Resumen de Privacidad</FuturisticCardTitle>
            </FuturisticCardHeader>
            <FuturisticCardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4 text-center">
                <div className="p-3 rounded-lg bg-green-500/10">
                  ...
                  <div className="text-xs text-green-300 font-manrope">
                    Datos Vendidos
                  </div>
                </div>
                <div className="p-3 rounded-lg bg-blue-500/10">
                  <div className="font-bold text-blue-400 font-orbitron">
                    24h
                  </div>
                  <div className="text-xs text-blue-300 font-manrope">
                    Respuesta DPO
                  </div>
                </div>
              </div>

...
import { downloadQRCode, generateQRCodeForExperience } from "@/lib/qr";
      ...
      <CardContent>
        <div className="flex items-center justify-center p-8 bg-white rounded-lg">
          {isGenerating ? (
            ...
            <img src={qrCode} alt="QR Code" className="w-32 h-32 rounded" />
          ) : (
...
export default function ExperienceViewPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center py-16">
          ...
          <QuickArLogo size={48} animated className="mb-4" />
  ...
  if (error) {
    return (
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="text-center py-16">
          <QuickArLogo size={64} className="mb-6 opacity-50" />
          ...
          <div className="flex gap-3">
            <Link href={`/ar/${experience.id}`}>
              <Button size="lg" className="bg-blue-600 hover:bg-blue-700">
                <QuickArLogo size={20} className="mr-2" />
                Ver en AR
              </Button>
            </Link>
            <Link href={`/experiences/${experience.id}/edit`}>
              <Button variant="outline" size="lg">
                <QuickArLogo size={18} className="mr-2 opacity-75" />
                Editar
              </Button>
            </Link>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="glass">
            <CardHeader>
              ...
              <CardDescription>Contenido de la experiencia AR</CardDescription>
            </CardHeader>
            <CardContent>
                        ...
                        <div className="flex-1">
                          ...
                          {asset.fileSizeBytes && (
                            <p className="text-xs text-gray-400 mt-1">
                              Tamaño: {(asset.fileSizeBytes / 1024).toFixed(1)}{" "}
                              KB
                            </p>
                          )}
                        </div>

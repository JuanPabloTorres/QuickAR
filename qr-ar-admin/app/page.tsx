...
export default function HomePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {features.map((feature) => (
          <Card
            ...
            className="hover:shadow-neon-md transition-all duration-300 group"
          >
            <CardHeader>
      ...
      <Card
        variant="elevated"
        className="bg-gradient-to-r from-brand-950/50 to-qr-950/50 border-brand-500/20"
      >
        <CardHeader>
          <CardTitle className="flex items-center space-x-3">
        ...
        <CardContent>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Link href="/experiences/new" className="flex-1">
              <Button
                size="lg"
                className="w-full shadow-neon-md hover:shadow-neon-lg transition-all duration-300"
              >

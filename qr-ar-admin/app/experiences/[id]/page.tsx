              ...
              {experience.assets.length === 0 ? (
                ...
                <div className="space-y-4">
                  {experience.assets.map((asset, index) => (
                    <div
                      key={asset.id}
                      className="group relative bg-[#1a2942]/50 rounded-xl p-6 border-2 border-transparent hover:border-[#3DD8B6] transition-all duration-300 hover:shadow-lg hover:shadow-[#3DD8B6]/20 hover:scale-[1.01]"
                      style={{
                      ...
                      <div className="relative z-10">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flex-1">
                            ...
                            <span className="inline-block text-xs px-4 py-2 bg-gradient-to-r from-[#3DD8B6] to-[#00D4FF] text-[#0F1C2E] rounded-full font-bold shadow-lg uppercase tracking-wide">
                              {
                                ASSET_KIND_LABELS[
                        ...
                        {asset.kind === "message" && asset.text && (
                          <div className="mt-4 p-4 bg-[#0F1C2E]/80 rounded-xl border border-[#3DD8B6]/30">
                            <span className="text-xs font-bold text-[#3DD8B6] uppercase tracking-wider mb-2 block">
                              💬 Mensaje
                            </span>
                            <p className="text-gray-300 leading-relaxed">
                              {asset.text}
                        ...
                        {asset.url && (
                          <div className="mt-4 p-4 bg-[#0F1C2E]/80 rounded-xl border border-[#00D4FF]/30 space-y-2">

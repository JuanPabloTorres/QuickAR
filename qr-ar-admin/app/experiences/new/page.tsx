              ...
              {fields.length === 0 ? (
                <div className="text-center py-24">
                  ...
                  <div className="relative mb-10">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#3DD8B6]/20 via-[#00D4FF]/20 to-purple-500/20 blur-3xl"></div>
                  </div>

                  {/* Main content */}
                  <div className="max-w-2xl mx-auto space-y-6">
                    <div className="relative inline-block">
                      <h3 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#3DD8B6] via-[#00D4FF] to-purple-500 mb-3">
                        ¡Tu lienzo AR está listo!
                      </h3>
                    ...
                    <p className="text-xl text-gray-300 leading-relaxed">
                      Agrega modelos 3D, imágenes, videos o mensajes para crear
                      una experiencia inolvidable
                    </p>

                    {/* Feature hints */}
                    <div className="grid grid-cols-2 gap-4 mt-8 max-w-xl mx-auto">
                      <div className="p-4 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl border-2 border-purple-500/20 hover:border-purple-500/40 transition-all hover:scale-105">
                        <div className="text-3xl mb-2">🎲</div>
                        <p className="text-sm text-gray-400 font-semibold">
                          Modelos 3D interactivos
                        </p>
                      </div>
                      <div className="p-4 bg-gradient-to-br from-[#3DD8B6]/10 to-[#00D4FF]/10 rounded-2xl border-2 border-[#3DD8B6]/20 hover:border-[#3DD8B6]/40 transition-all hover:scale-105">
                        <div className="text-3xl mb-2">🖼️</div>
                        <p className="text-sm text-gray-400 font-semibold">
                          Imágenes HD flotantes
                        </p>
                      </div>
                      <div className="p-4 bg-gradient-to-br from-orange-500/10 to-red-500/10 rounded-2xl border-2 border-orange-500/20 hover:border-orange-500/40 transition-all hover:scale-105">
                        <div className="text-3xl mb-2">🎬</div>
                        <p className="text-sm text-gray-400 font-semibold">
                          Videos inmersivos
                        </p>
                      </div>
                      <div className="p-4 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl border-2 border-blue-500/20 hover:border-blue-500/40 transition-all hover:scale-105">
                        <div className="text-3xl mb-2">💬</div>
                        <p className="text-sm text-gray-400 font-semibold">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-8 text-gray-500">
                      <div className="w-2 h-2 rounded-full bg-[#3DD8B6] animate-pulse"></div>
                      <span className="text-sm font-medium">
                        Usa los botones arriba para comenzar
                      </span>
                    </div>
                  </div>
                </div>

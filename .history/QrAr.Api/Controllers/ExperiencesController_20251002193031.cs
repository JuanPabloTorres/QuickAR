...
public class ExperiencesController : ControllerBase
{
    ...
    public static void MapExperienceEndpoints(IEndpointRouteBuilder app)
    {
        ...
        experienceGroup.MapGet("", GetAllExperiences)
            .WithSummary("Get all experiences");

        experienceGroup.MapGet("{id:guid}", GetExperienceById)
            .WithSummary("Get experience by ID");

        experienceGroup.MapGet("slug/{slug}", GetExperienceBySlug)
            .WithSummary("Get experience by slug");

        experienceGroup.MapPost("", CreateExperience)
            .WithSummary("Create new experience");

        experienceGroup.MapPut("{id:guid}", UpdateExperience)
            .WithSummary("Update experience");

        experienceGroup.MapDelete("{id:guid}", DeleteExperience)
            .WithSummary("Delete experience");

        experienceGroup.MapPatch("{id:guid}/toggle-active", ToggleExperienceActive)

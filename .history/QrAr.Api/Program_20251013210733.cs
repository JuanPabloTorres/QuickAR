...
using MySqlServerVersion = Pomelo.EntityFrameworkCore.MySql.Infrastructure.MySqlServerVersion;
...
builder.Services.AddDbContext<AppDbContext>(options =>
{
    ...
    options.UseMySql(connectionString, 
        new Pomelo.EntityFrameworkCore.MySql.Infrastructure.MySqlServerVersion(new Version(8, 0, 40)),

...
export class QRCodeGenerator {
   ...
   */
  static async downloadQR(text: string, filename: string = 'qrcode.png', options?: QRCodeOptions): Promise<void> {
    try {
...
export const generateExperienceQRSVG = (slug: string, options?: QRCodeOptions) => 
  QRCodeGenerator.generateExperienceQRSVG(slug, undefined, options);

export const downloadExperienceQR = (slug: string, filename?: string, options?: QRCodeOptions) => {

...
export const assetCreateSchema = z.object({
  ...
  text: z.string().max(2000, 'El texto no puede exceder 2000 caracteres').optional().nullable(),
});
...
export const experienceFormSchema = z.object({
  ...
  assets: z.array(z.object({
    ...
    text: z.string().max(2000, 'El texto no puede exceder 2000 caracteres').optional(),
  })).default([]),
});
...
export const validateAssetFile = (file: File, assetKind: AssetKind): string | null => {

...
export function ExperienceCube({
              ...
              dangerouslySetInnerHTML={{
                __html: `
                  <model-viewer
                    ...
                    ${enableAR && arAvailable ? 'ar ar-modes="webxr scene-viewer quick-look"' : ''}
                    ar-scale="${arScale}"
  ...
  return (
    <motion.div
      className={`experience-cube-ar relative bg-gradient-to-br from-white/40 to-gray-50/30 backdrop-blur-sm rounded-2xl shadow-md border border-gray-200/50 overflow-hidden ${className}`}
      style={{
        width: size,
        height: size,
        minWidth: 300,

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-md">
              Plataforma profesional para crear y gestionar experiencias de realidad aumentada 
              activadas por códigos QR. Transforma la forma en que interactúas con tu audiencia.
            </p>
          </div>

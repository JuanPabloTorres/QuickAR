...
import { FileText, Image, Package, Play } from "lucide-react";
      ...
      case "model3d":
        ...
        return (
          <div className="flex flex-col items-center justify-center h-full">
            {/* Placeholder for 3D model - would integrate with model-viewer or similar */}
            <Package className="w-12 h-12 text-gray-400 mb-2" />
            <p className="text-xs text-gray-500 text-center px-4">
              Modelo 3D
              <br />
              <span className="text-xs opacity-75">
                {disableModelZoom ? "Zoom: Desactivado" : "Zoom: Activado"}
              </span>
            </p>
            {/* Future: model-viewer component */}
            {/* <model-viewer 
              src={assetUrl} 
              alt={alt}
              disable-zoom={disableModelZoom}
              disable-pan={disableModelPan}

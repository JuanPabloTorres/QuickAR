    ...
    >
      ...
      {enableAR && arAvailable && (
        <div className="absolute top-3 right-3 z-30">
          ...
          >
            {capabilities.webXR ? 'WebXR' : capabilities.sceneViewer ? 'Scene' : capabilities.quickLook ? 'QuickLook' : 'AR'}
          </motion.div>
        </div>
      )}
        ...
        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-white/10 via-gray-50/5 to-transparent rounded-xl border border-gray-300/20 backdrop-blur-md shadow-inner">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-sm text-gray-600 font-medium">Cargando experiencia AR...</p>
            </div>
          ) : hasError ? (
            renderFallback()
          ) : (

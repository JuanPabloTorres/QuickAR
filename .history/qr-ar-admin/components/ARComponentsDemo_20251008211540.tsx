      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-gray-600">
            Componentes AR mejorados con contratos unificados (camelCase) y
          ...
          <div className="space-y-4">
            ...
            <ExperienceCubeRefactored
              ...
              educationalContent={{
                ...
                description:
                  "Los mensajes de texto pueden incluir información educativa y se renderizan de forma consistente.",
                audioUrl: undefined,
              }}
              className="mb-4"
            />
          ...
          <div className="space-y-4">
            ...
            <ExperienceCubeRefactored
              ...
              educationalContent={{
                ...
                description:
                  "Los videos se pueden reproducir en AR con controles manuales.",
              }}
              className="mb-4"
            />
          </div>
            ...
            <div className="flex justify-center">
              <ExperienceCubeRefactored
                ...
                educationalContent={{
                  ...
                  description:
                    "Este astronauta se puede ver en AR con controles manuales completos. Usa los botones para mover, rotar y escalar el modelo antes de pasar a AR.",
                }}
                onARStateChange={(isInAR) => {
                  console.log(
                    "Estado AR cambiado:",
                    isInAR ? "Activo" : "Desactivado"
                  );
                }}
                className="mb-4"
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                <li>
                  • <code>assetKind</code> (message, image, video, model3d)
                </li>
        ...
        <div className="mt-8 bg-blue-50 rounded-lg border border-blue-200 p-6">
          ...
          <div className="text-sm text-blue-800 space-y-2">
            ...
            <p>
              <strong>AR Engine:</strong> @google/model-viewer + Three.js +
              WebXR
            </p>
            <p>
              <strong>Styling:</strong> Tailwind CSS + CSS Modules para AR
            </p>
            <p>
              <strong>Animaciones:</strong> Framer Motion para transiciones
            </p>
            <p>
              <strong>Compatibilidad:</strong> iOS (Quick Look) + Android (Scene
              Viewer) + Navegadores WebXR
            </p>
          </div>
        </div>
      </div>

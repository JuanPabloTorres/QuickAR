    ...
    >
        ...
        {onSortChange && (
          <div className="flex items-center space-x-1">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => onSortChange(sortBy || "title", sortOrder === "asc" ? "desc" : "asc")}
            >
              {sortOrder === "asc" ? (
      ...
      >
        {showFilters && (
          ...
          >
            <h4 className="text-sm font-medium text-gray-300 mb-3">Filtrar por:</h4>
            ...
            {hasActiveFilters && (
              ...
              >
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => filters.forEach(f => f.active && onFilterToggle?.(f.key))}

...
const FormCheckbox = forwardRef<HTMLInputElement, InputHTMLAttributes<HTMLInputElement>>(
  ({ className, ...props }, ref) => (
    <input
      type="checkbox"
      className={cn(
...
export { Form, FormGroup, FormLabel, FormInput, FormTextarea, FormMessage, FormCheckbox, Input }
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-center justify-between space-y-4 lg:space-y-0">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 lg:ml-4 min-w-fit">
          <Link href={`/experiences/${experience.id}`} className="w-full sm:w-auto">
            <AnimatedButton variant="outline" size="sm" className="w-full sm:w-auto justify-center">
              <Eye className="w-4 h-4 mr-2" />
              Ver
            </AnimatedButton>
          </Link>

          <Link href={`/experiences/${experience.id}/edit`} className="w-full sm:w-auto">
            <AnimatedButton variant="outline" size="sm" className="w-full sm:w-auto justify-center">

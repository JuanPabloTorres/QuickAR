...
const ARViewer: React.FC<{ experience: ExperienceDto }> = ({ experience }) => {
  ...
  const openImageAR = (imageUrl: string, imageName: string) => {
    ...
    arScene.style.cssText = 'position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 9999;';
    ...
    closeBtn.style.cssText = 'position: absolute; top: 20px; right: 20px; z-index: 10000; background: rgba(0,0,0,0.8); color: white; border: none; padding: 10px 20px; border-radius: 25px; font-size: 16px;';
    closeBtn.onclick = () => {
            ...
            {currentAsset.kind === "model3d" ? (
              ...
              <button
                onClick={() => {
                  ...
                  openImageAR(getAssetUrl(currentAsset.url || ""), currentAsset.name);
                }}
              ...
              <button
                onClick={() => {
                  ...
                  openVideoAR(getAssetUrl(currentAsset.url || ""), currentAsset.name);
                }}

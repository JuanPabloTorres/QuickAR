...
export default function ARExperiencePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-brand-950 to-qr-950">
            ...
            <div className="glass rounded-3xl p-6 bg-gradient-to-br from-surface/20 to-surface-elevated/20">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-300 mb-6">
                  Experimenta este contenido en realidad aumentada
                </p>
                <button
                  onClick={() => {
                    setShowARViewer(true);
                    trackEvent("ar_viewer_opened", currentAsset.name);
                  }}
                  className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-3 px-8 rounded-full text-lg transition-all duration-300 transform hover:scale-105"
                >
                  🚀 Ver en AR
                </button>
              </div>
      ...
      {/* AR Viewer Modal */}
      {showARViewer && experience && (
        <ARViewer
          asset={experience.assets[currentAssetIndex]}
          assetUrl={experience.assets[currentAssetIndex].url || ''}
          assetName={experience.assets[currentAssetIndex].name}
          onClose={() => {
            setShowARViewer(false);
            trackEvent("ar_viewer_closed");
          }}

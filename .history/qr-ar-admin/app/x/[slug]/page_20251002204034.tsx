...
const Enhanced3DViewer = dynamic(
  () => import("@/src/components/ui/Enhanced3DViewer"),
  {
    ssr: false,
    loading: () => (
              ...
              {asset.kind === "model3d" ? (
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-white/50">
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-slate-600">
                      Modelo 3D interactivo con controles de arrastre mejorados
                    </p>
                  </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-lg border border-white/50">
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-slate-600">
                      Contenido AR interactivo
                    </p>
                  </div>
                  <div className="h-96 w-full">
                    <ARViewer asset={asset} onTrackEvent={trackEvent} />
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50">
            ...
            <div className="space-y-3 text-slate-600">
              <p className="flex items-start gap-2">
                ...
                <span>
                  Presiona <strong>"Ver en AR"</strong> para activar la
                  experiencia
                </span>
              </p>
              <p className="flex items-start gap-2">
              ...
              <p className="flex items-start gap-2">
                ...
                <span>
                  Mueve tu dispositivo para explorar el contenido en 3D
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50">
            ...
            <div className="space-y-3 text-slate-600">
              <p className="flex items-start gap-2">
                ...
                <span>
                  <strong>Arrastra</strong> para rotar modelos 3D
                </span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-purple-500 font-bold">•</span>
                <span>
                  <strong>Pellizca</strong> para hacer zoom
                </span>
              </p>
              <p className="flex items-start gap-2">
                <span className="text-purple-500 font-bold">•</span>
                <span>
                  <strong>Navega</strong> entre múltiples contenidos
                </span>
              </p>
            </div>
          </div>

          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div>
                ...
                <FormField label="" name="bio">
                  <textarea
                    rows={4}
                    defaultValue="Creador de experiencias AR innovadoras"
                    placeholder="Cuéntanos sobre ti..."
                    className="w-full px-4 py-3 bg-[#0F1C2E]/80 border-2 border-[#1a2942] focus:border-[#3DD8B6] rounded-xl text-white placeholder-gray-500 focus:ring-0 transition-all resize-none"
                  />
                </FormField>
                <p className="text-gray-400 text-sm mt-2">

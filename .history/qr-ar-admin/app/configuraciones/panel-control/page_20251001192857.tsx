...
import { FormInput, FormTextarea, FormCheckbox } from "@/components/ui/form";
...
export default function SettingsPage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      bio: "Creador de experiencias AR innovadoras",
    },
    mode: "onChange",
  });
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center gap-6 p-6 bg-[#1a2942]/30 rounded-xl">
              ...
              <div>
                <Button
                  type="button"
                  className="bg-[#3DD8B6] hover:bg-[#3DD8B6]/90 text-[#0F1C2E] font-bold"
                >
                  Cambiar Foto
                </Button>
            ...
            <div className="pt-6 border-t-2 border-[#1a2942] flex justify-end">
              <Button
                type="submit"
                disabled={isSaving}
              ...
              <CardContent className="p-6">
                ...
                <form className="space-y-4">
                  <FormInput
                    ...
                    register={(name) => register(name, validationRules.currentPassword)}
                  ...
                  <FormInput
                    ...
                    name="newPassword"
                    register={(name) => register(name, validationRules.newPassword)}
                  ...
                  <FormInput
                    ...
                    register={(name) => register(name, validationRules.confirmPassword)}

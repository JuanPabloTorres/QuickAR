...
import { getPrimaryAsset, mapAssetToExperienceCube } from "@/lib/asset-mappers";
            ...
            {viewMode === "grid" ? (
              ...
              <div className="min-h-screen bg-gradient-to-br from-purple-900/20 via-blue-900/10 to-gray-900/20 rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                  {filteredAndSortedExperiences.map((experience, index) => {
                    // Get the primary asset using mapper utility
                    const primaryAsset = getPrimaryAsset(experience.assets);
                    const cubeProps = primaryAsset
                      ? mapAssetToExperienceCube(primaryAsset)
                      : {

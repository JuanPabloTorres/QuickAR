        ...
        <PageHeader
          ...
          action={
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              {/* View Mode Toggle */}
              <div className="flex items-center border border-slate-700/50 rounded-lg p-1 bg-slate-800/30 w-full sm:w-auto justify-center">
                <Button
      ...
      <AnimatePresence mode="wait">
        {filteredAndSortedExperiences.length === 0 ? (
          ...
          >
            {viewMode === "grid" ? (
              <AnimatedCardGrid
                className="grid-cols-1 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6"
                stagger
              >

              ...
              {fields.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-muted-foreground">
                    No hay assets en esta experiencia. Agrega contenido usando
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <input
                            ...
                            className="flex-1 px-3 py-2 rounded-md bg-slate-800 border border-slate-600 text-foreground placeholder-muted-foreground focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                          />
                        </div>
                        <Button
                          type="button"
                      ...
                      {field.kind === "message" ? (
                        <div className="space-y-2">
                          ...
                          <textarea
                            ...
                            rows={3}
                            className="w-full px-3 py-2 rounded-md bg-slate-800 border border-slate-600 text-foreground placeholder-muted-foreground focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                          />
                        </div>
                      ) : (
                          ...
                          {field.url ? (
                              ...
                              <div className="flex items-center justify-between p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                                <div>
                                  ...
                                  <p className="text-xs text-muted-foreground">
                                    {field.mimeType} •{" "}
                                    {formatFileSize(field.fileSizeBytes || 0)}
                                  </p>
                                </div>
                                <Button
                                  type="button"
                            ...
                            <FileUpload
                              ...
                              onFileSelect={(file: File) => {
                                // Handle file selection - you'll need to implement upload logic

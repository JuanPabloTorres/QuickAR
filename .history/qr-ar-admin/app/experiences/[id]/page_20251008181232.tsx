...
import { ASSET_KIND_LABELS, Exper                </>
              )
            }nceDto } from "@/types";
import {
  BarChart3,
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    {experience.assets.map((asset, index) => {
                      ...
                      return (
                        <div key={asset.id} className="flex flex-col items-center space-y-4">
                          <ExperienceCube
                          ...
                          <div className="w-full max-w-xs bg-[#1a2942]/50 rounded-xl p-4 border border-[#3DD8B6]/20 backdrop-blur-sm">
                            <div className="text-center">
                              ...
                              <div className="mt-3 space-y-1 text-xs text-gray-400">
                                {asset.mimeType && (
                                  <div>
                                    <span className="font-semibold text-[#3DD8B6]">Tipo:</span> {asset.mimeType}
                                  </div>
                                )}
                                {asset.fileSizeBytes && (
                                  <div>
                                    <span className="font-semibold text-[#3DD8B6]">Tamaño:</span> {formatFileSize(asset.fileSizeBytes)}
                                  </div>
                                )}
                              </div>
                            </div>

                  ...
                  {experience.assets.map((asset, index) => (
                    ...
                    >
                      ...
                      {asset.url && (
                        <div className="mt-4 p-3 bg-purple-900/30 rounded-lg border border-purple-700/50 space-y-2">
                          <div className="flex items-center text-sm">
                            <span className="text-purple-300 font-semibold mr-2">URL:</span>
                            <a
                              href={asset.url}
                              target="_blank"
                              rel="noopener noreferrer"
                          ...
                          {asset.mimeType && (
                            <div className="text-xs text-purple-200">
                              <span className="font-semibold">Tipo:</span> {asset.mimeType}
                            </div>
                          )}
                          {asset.fileSizeBytes && (
                            <div className="text-xs text-purple-200">
                              <span className="font-semibold">Tamaño:</span> {formatFileSize(asset.fileSizeBytes)}
                            </div>
                          )}
                        </div>
                      )}
        ...
        <div className="space-y-6">
          ...
          <Card className="border-2 hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent className="space-y-4 pt-6 pb-6">
              <Link href={`/x/${experience.slug}`} target="_blank" className="block">
                <Button 
                  variant="outline" 
                  className="w-full h-auto py-4 px-5 group hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 dark:hover:from-blue-950 dark:hover:to-blue-900 transition-all hover:scale-105 hover:shadow-lg border-2 hover:border-blue-300 dark:hover:border-blue-700"
                >
                  <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-semibold">Vista Previa AR</span>
                    </div>
                    <ExternalLink className="w-4 h-4 text-blue-600 dark:text-blue-400 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                  </div>
                </Button>
              </Link>

              <Link href={`/analytics?experienceId=${experience.id}`} className="block">
                <Button 
                  variant="outline" 
                  className="w-full h-auto py-4 px-5 group hover:bg-gradient-to-r hover:from-purple-50 hover:to-purple-100 dark:hover:from-purple-950 dark:hover:to-purple-900 transition-all hover:scale-105 hover:shadow-lg border-2 hover:border-purple-300 dark:hover:border-purple-700"
                >
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <span className="font-semibold">Ver Analytics</span>
                  </div>
                </Button>
              </Link>
              ...
              <Link href={`/experiences/${experience.id}/edit`} className="block">
                <Button 
                  variant="outline" 
                  className="w-full h-auto py-4 px-5 group hover:bg-gradient-to-r hover:from-green-50 hover:to-green-100 dark:hover:from-green-950 dark:hover:to-green-900 transition-all hover:scale-105 hover:shadow-lg border-2 hover:border-green-300 dark:hover:border-green-700"
                >
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <span className="font-semibold">Editar Experiencia</span>
                  </div>
                </Button>
              </Link>
            </CardContent>

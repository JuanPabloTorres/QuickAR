...
import { mapAssetToExperienceCube } from "@/lib/experience-cube-mapper";
            ...
            <CardContent className="pt-6">
              {experience.assets.length === 0 ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8 perspective-container">
                    {experience.assets.map((asset, index) => (
                      ...
                      >
                        <ExperienceCube
                          {...mapAssetToExperienceCube(asset, {
                            size: 280,
                            enableAR: true,
                            className: "mx-auto"
                          })}

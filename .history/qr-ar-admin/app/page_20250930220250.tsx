    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <p className="text-blue-100 text-sm mb-4">
              Diseña experiencias de realidad aumentada que se activan mediante códigos QR.
              Sube modelos 3D, imágenes, videos o crea mensajes interactivos.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-blue-100 text-sm mb-4">
              Cada experiencia genera automáticamente un código QR que los usuarios
              pueden escanear para acceder a la experiencia AR.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-blue-100 text-sm mb-4">
              Obtén insights sobre cómo los usuarios interactúan con tus experiencias,
              incluyendo visualizaciones, interacciones y duración.
            </p>
            <Link href="/analytics">
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-white">Crear una experiencia</h4>

...
export const SEO_CONFIG = {
  ...
  DEFAULT_DESCRIPTION:
    "Crea y gestiona experiencias de Realidad Aumentada de forma fácil y profesional",
  DEFAULT_KEYWORDS:
    "AR, Realidad Aumentada, 3D, Experiencias, WebXR, model-viewer",
  SITE_NAME: "Quick AR",
  ...
  return {
    ...
    supportedFormats:
      FILE_CONFIG.SUPPORTED_FORMATS[
        type.toUpperCase() as keyof typeof FILE_CONFIG.SUPPORTED_FORMATS
      ],
    supportedMimeTypes:
      FILE_CONFIG.MIME_TYPES[
        type.toUpperCase() as keyof typeof FILE_CONFIG.MIME_TYPES
      ],
  };
}

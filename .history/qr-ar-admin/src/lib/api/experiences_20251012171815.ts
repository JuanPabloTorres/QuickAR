...
const getApiBaseUrl = () => {
  ...
  // Client-side fallback - always use localhost for API regardless of frontend hostname
  // The backend is running on localhost, even if frontend is accessed via network IP

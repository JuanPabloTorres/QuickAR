...
export default function Analytics() {
  ...
  const deviceData = [
    { name: "Móvil", value: 65, color: "#38bdf8", colorClass: "bg-sky-400" },
    { name: "Desktop", value: 25, color: "#6366f1", colorClass: "bg-indigo-500" },
    { name: "Tablet", value: 10, color: "#9333ea", colorClass: "bg-purple-600" },
  ];

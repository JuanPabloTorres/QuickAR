  ...
  const faqItems = [
    {
      ...
      answer: "Puedes subir modelos 3D en formato .glb o .gltf a través del panel de administración. Ve a 'Crear Experiencia' y selecciona tu archivo.",
      category: "getting-started"
    },
    {
      question: "¿Qué formatos de archivo son compatibles?",
      answer: "Soportamos modelos 3D (.glb, .gltf), imágenes (.jpg, .png, .webp) y videos (.mp4, .webm) para experiencias AR.",
      category: "technical"
    },
    {
      question: "¿Cómo genero un código QR para mi experiencia?",
      answer: "Una vez creada tu experiencia AR, se genera automáticamente un código QR único que puedes descargar desde el dashboard.",
      category: "getting-started"
    },
    {
      question: "¿La plataforma funciona en todos los dispositivos móviles?",
      answer: "QuickAR es compatible con dispositivos iOS y Android modernos que soporten WebXR o AR Core/ARKit.",
      category: "technical"
    }
  ];
          ...
          <FuturisticCard variant="glass" glow>
            ...
            <FuturisticCardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <FuturisticButton type="submit" className="w-full" size="lg" glow>
          ...
          <FuturisticCard variant="default">
            ...
            <FuturisticCardContent className="space-y-4">
              <div className="flex items-center space-x-3 p-3 rounded-lg bg-white/5">
                ...
                <div>
                  <div className="font-medium font-manrope text-white text-sm">Email</div>
                  <div className="text-xs text-slate-400 font-manrope">support@quickar.com</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-3 rounded-lg bg-white/5">
                ...
                <div>
                  <div className="font-medium font-manrope text-white text-sm">Teléfono</div>
                  <div className="text-xs text-slate-400 font-manrope">+1 (555) 123-4567</div>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3 p-3 rounded-lg bg-white/5">
                ...
                <div>
                  <div className="font-medium font-manrope text-white text-sm">Horario</div>
                  <div className="text-xs text-slate-400 font-manrope">Lun-Vie 9:00-18:00</div>
                </div>
              </div>
            </FuturisticCardContent>
          </FuturisticCard>
          ...
          <FuturisticCard variant="glass" glow>
            ...
            <FuturisticCardContent className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300 font-manrope">API Backend</span>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <span className="text-xs text-green-400 font-manrope">Operativo</span>
                </div>
              </div>
              
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300 font-manrope">Base de Datos</span>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <span className="text-xs text-green-400 font-manrope">Operativo</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300 font-manrope">CDN de Archivos</span>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <span className="text-xs text-green-400 font-manrope">Operativo</span>
                </div>
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300 font-manrope">Servicio AR</span>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-yellow-400 rounded-full animate-pulse"></div>
                  <span className="text-xs text-yellow-400 font-manrope">Mantenimiento</span>
                </div>
              </div>

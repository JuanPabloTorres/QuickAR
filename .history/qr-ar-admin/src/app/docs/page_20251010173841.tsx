            ...
            <FuturisticCardContent className="space-y-6">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-slate-300 font-manrope mb-4">
                  QuickAR es una plataforma completa para crear y gestionar
                  experiencias de realidad aumentada. Permite a desarrolladores
                  y creadores de contenido generar experiencias AR interactivas
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                  ...
                  <p className="text-sm text-green-300 font-manrope">
                    Comienza subiendo un modelo 3D en formato .glb para crear tu
                    primera experiencia AR.
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
                  ...
                  <p className="text-sm text-blue-300 font-manrope">
                    La API está disponible en https://localhost:5002 para
                    desarrollo local.
                  </p>
                </div>
              </div>
  ...
  "assetUrl": "/uploads/models/model.glb"
        ...
        <div className="space-y-6">
          ...
          <FuturisticCard variant="default">
            <FuturisticCardHeader>
              <FuturisticCardTitle>Navegación</FuturisticCardTitle>
            </FuturisticCardHeader>
            <FuturisticCardContent>
              <div className="space-y-4">
          ...
          <FuturisticCard variant="neon">
            <FuturisticCardHeader>
              <FuturisticCardTitle>¿Necesitas Ayuda?</FuturisticCardTitle>
            </FuturisticCardHeader>

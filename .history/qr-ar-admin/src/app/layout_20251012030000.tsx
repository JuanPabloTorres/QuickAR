  ...
  return (
    <html lang="es" className="dark">
      <head>
        ...
        <meta httpEquiv="Permissions-Policy" content="camera=*, microphone=*, gyroscope=*, accelerometer=*, xr-spatial-tracking=*" />
        <meta httpEquiv="Feature-Policy" content="xr-spatial-tracking 'self'; camera 'self'; microphone 'self'; gyroscope 'self'; accelerometer 'self'" />

...
export default function Dashboard() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (response.success) {
          ...
          const mockExperiences: Experience[] = response.data.map((exp: any) => ({
            id: exp.id,
            title: exp.title,
            slug: exp.slug,
            ...
            assets: exp.assetUrl ? [{
              id: `asset-${exp.id}`,
              name: `Asset for ${exp.title}`,
              assetType: exp.assetType as any,
              assetUrl: exp.assetUrl,
              mimeType: undefined,
  ...
  const stats = {
    ...
    totalViews: experiences.reduce((sum, exp) => sum + ((exp as any).viewCount || 0), 0), // TODO: Add viewCount to Experience type
    totalAssets: experiences.reduce((sum, exp) => sum + (exp.assets ? exp.assets.length : 0), 0),
  };
      ...
      <div className="container mx-auto px-4 py-8 space-y-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in-50 duration-700 delay-300">
          <FuturisticCard
            variant="neon"
            hover
            className="transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/20"
          >
          ...
          <FuturisticCard
            variant="glass"
            glow
            className="transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20"
          >
            <FuturisticCardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              {loading ? (
                ...
                <div className="text-2xl font-bold font-orbitron text-white hover:text-green-400 transition-colors cursor-default">
                  ...
                  {stats.activeQRCodes > 0 && (
                    <CheckIcon
                      className="ml-2 inline-block animate-bounce text-green-400"
                      size={20}
                    />
                  )}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in-50 duration-700 delay-500">
          <FuturisticCard
            variant="glass"
            glow
            className="transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/30 group"
          >
            <FuturisticCardHeader>
              <QuickArLogo
                size={48}
          ...
          <FuturisticCard
            variant="neon"
            className="transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/30 group"
          >
            <FuturisticCardHeader>
              <QuickArLogo
                size={48}
        ...
        <FuturisticCard
          variant="default"
          glow
          className="animate-in fade-in-50 duration-700 delay-700"
        >
          <FuturisticCardHeader>
          ...
          <FuturisticCardContent className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Link href="/experiences/create" className="block">
              ...
              >
                <PlusIcon
                  size={24}
                  className="hover:animate-pulse transition-all duration-500"
                />
            ...
            <Link href="/analytics" className="block">
              ...
              >
                <AnalyticsIcon
                  size={24}
                  className="hover:animate-bounce transition-all duration-500"
                />

  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 space-y-8 relative z-10">
        {/* Hero Section */}
        <div className="text-center py-8 animate-in fade-in-50 slide-in-from-top-4 duration-1000">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in fade-in-50 duration-700 delay-300">
          <FuturisticCard variant="neon" hover className="transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/20">
          ...
          <FuturisticCard variant="glass" glow className="transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20">
            <FuturisticCardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <FuturisticCard variant="neon" className="transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-yellow-500/20">
            <FuturisticCardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <FuturisticCardTitle className="text-sm font-medium font-manrope">
                Visualizaciones
              </FuturisticCardTitle>
          ...
          <FuturisticCard variant="default" className="transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20">
            <FuturisticCardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <FuturisticCardTitle className="text-sm font-medium font-manrope">
                QR Activos
              </FuturisticCardTitle>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-in fade-in-50 duration-700 delay-500">
          <FuturisticCard variant="glass" glow className="transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/30 group">
            <FuturisticCardHeader>
              <QuickArLogo size={48} className="mb-2 group-hover:animate-pulse" />
              <FuturisticCardTitle>
          ...
          <FuturisticCard variant="neon" className="transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-indigo-500/30 group">
            <FuturisticCardHeader>
              <QuickArLogo size={48} className="mb-2 group-hover:animate-pulse" />
        ...
        {/* Quick Actions */}
        <FuturisticCard variant="default" glow className="animate-in fade-in-50 duration-700 delay-700">
          <FuturisticCardHeader>
          ...
          <FuturisticCardContent className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/experiences" className="block">
              <FuturisticButton
                variant="ghost"
                className="w-full h-auto p-6 flex flex-col space-y-2 transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                <SparklesIcon size={24} className="hover:animate-spin transition-all duration-500" />
            ...
            <Link href="/experiences/create" className="block">
              <FuturisticButton
                ...
                className="w-full h-auto p-6 flex flex-col space-y-2 transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                <PlusIcon size={24} className="hover:animate-pulse transition-all duration-500" />
            ...
            <Link href="/analytics" className="block">
              <FuturisticButton
                ...
                className="w-full h-auto p-6 flex flex-col space-y-2 transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                <AnalyticsIcon size={24} className="hover:animate-bounce transition-all duration-500" />
            ...
            <Link href="/settings" className="block">
              <FuturisticButton
                ...
                className="w-full h-auto p-6 flex flex-col space-y-2 transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                <SettingsIcon size={24} className="hover:animate-spin transition-all duration-500" />

...
import { FloatingDecoration, AchievementNotification, FunLoadingSkeleton } from "@/components/ui/floating-particles";
...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <EasterEggProvider 
        onActivate={() => {
          setNewAchievement({ title: "🎮 Master Hacker", description: "Descubriste el código Konami!" });
          ...
          <FuturisticCardContent>
            {loading ? (
              ...
              <div className="text-2xl font-bold font-orbitron text-white hover:text-indigo-400 transition-colors cursor-default">
                {stats.totalAssets}
                {stats.totalAssets > 0 && <span className="ml-2 text-lg animate-pulse">💎</span>}
              </div>
            )}
          ...
          <FuturisticCardContent>
            {loading ? (
              ...
              <div className="text-2xl font-bold font-orbitron text-white hover:text-yellow-400 transition-colors cursor-default">
                ...
                {stats.totalViews > 100 && <span className="ml-2 text-lg animate-ping">⚡</span>}
              </div>
            )}
            <p className="text-xs text-slate-400 font-manrope">
          ...
          <FuturisticCardContent>
            {loading ? (
              ...
              <div className="text-2xl font-bold font-orbitron text-white hover:text-green-400 transition-colors cursor-default">
                {stats.activeQRCodes}
                {stats.activeQRCodes > 0 && <span className="ml-2 text-lg animate-bounce">🟢</span>}
              </div>
            )}
            <p className="text-xs text-slate-400 font-manrope">

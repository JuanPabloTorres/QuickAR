      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            {/* Basic Information */}
            <FuturisticCard variant="glass" glow className="animate-in fade-in-50 duration-500">
              <FuturisticCardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <UserIcon size={24} className="text-sky-400" />
                    <FuturisticCardTitle>Información Personal</FuturisticCardTitle>
                  </div>
                  <FuturisticButton
                    variant="ghost"
                    size="sm"
            ...
            <FuturisticCard variant="neon" className="animate-in fade-in-50 duration-500 delay-150">
              <FuturisticCardHeader>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                  ...
                  <form onSubmit={handlePasswordChange} className="space-y-6">
                    <div>
                      ...
                      <FuturisticInput
                        ...
                        leftIcon={KeyIcon}
                        rightIcon={passwordVisible.current ? EyeOffIcon : EyeIcon}
                        onRightIconClick={() => setPasswordVisible({ ...passwordVisible, current: !passwordVisible.current })}
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <FuturisticInput
                        ...
                        leftIcon={KeyIcon}
                        rightIcon={passwordVisible.new ? EyeOffIcon : EyeIcon}
                        onRightIconClick={() => setPasswordVisible({ ...passwordVisible, new: !passwordVisible.new })}
                        required
                        minLength={6}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <FuturisticInput
                        ...
                        leftIcon={KeyIcon}
                        rightIcon={passwordVisible.confirm ? EyeOffIcon : EyeIcon}
                        onRightIconClick={() => setPasswordVisible({ ...passwordVisible, confirm: !passwordVisible.confirm })}
                        required
                        minLength={6}
                      />
                    </div>
          ...
          <div className="space-y-8">
            {/* Account Status */}
            <FuturisticCard variant="default" className="animate-in fade-in-50 duration-500 delay-300">
              <FuturisticCardHeader>
                <div className="flex items-center space-x-3">
              ...
              <FuturisticCardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-slate-800/50 border border-slate-700 rounded-lg">
                  ...
                  <span className={user.isEmailConfirmed ? 'text-green-400' : 'text-yellow-400'}>
            ...
            {/* Account Timeline */}
            <FuturisticCard variant="glass" className="animate-in fade-in-50 duration-500 delay-450">
              <FuturisticCardHeader>
                <div className="flex items-center space-x-3">
            ...
            {/* Profile Achievement */}
            <FuturisticCard variant="neon" className="animate-in fade-in-50 duration-500 delay-600">
              <FuturisticCardHeader>
                <div className="flex items-center space-x-3">

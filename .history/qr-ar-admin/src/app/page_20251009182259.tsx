  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="glass">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Assets Totales</CardTitle>
            <div className="text-2xl">📦</div>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <Card className="glass">
          <CardHeader>
            ...
            <CardDescription>
              Crea experiencias inmersivas de AR con imágenes, videos, modelos 3D y mensajes interactivos.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">Soporte para múltiples tipos de contenido</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-green-400">✓</span>
        ...
        <Card className="glass">
          <CardHeader>
            ...
            <CardDescription>
              Genera códigos QR dinámicos que enlazan directamente a tus experiencias de realidad aumentada.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <span className="text-green-400">✓</span>
                <span className="text-sm">Tracking y analytics en tiempo real</span>
              </div>
              <div className="flex items-center space-x-2">
                <span className="text-green-400">✓</span>
                <span className="text-sm">Compatibilidad multi-dispositivo</span>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="glass">
        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/experiences" className="block">
            <Button variant="ghost" className="w-full h-auto p-6 flex flex-col space-y-2">
              <div className="text-2xl">📋</div>

...
import { QuickArL          <FuturisticCardContent>
            {loading ? (
              ...
              <div className="text-3xl font-bold font-orbitron text-white hover:text-sky-400 transition-colors cursor-default">
                {stats.totalExperiences}
                {stats.totalExperiences > 0 && <span className="ml-2 text-lg animate-bounce">🚀</span>}
              </div>
            )}
            <p className="text-sm text-slate-400 font-manrope">
              {error ? '❌ Error loading data' : '✨ Experiencias creadas'}
            </p>
          </FuturisticCardContent>components/ui/quick-ar-logo";

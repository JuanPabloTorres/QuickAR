...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Extract error details if available and provide user-friendly messages
      ...
      if (error?.response?.status === 401) {
        ...
        details = ["Por favor, intenta nuevamente o contacta al soporte"];
      }
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-4">
              <div className="relative">
                <div className="w-20 h-20 sm:w-16 sm:h-16 bg-gradient-to-br from-sky-400 to-indigo-500 rounded-xl flex items-center justify-center shadow-2xl">
                  <Sparkles className="w-10 h-10 sm:w-8 sm:h-8 text-white" />
                </div>
            ...
            <p className="text-slate-300 font-manrope text-base sm:text-sm">

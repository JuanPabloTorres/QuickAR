    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-16">
          ...
          <div className="text-xl font-semibold text-white">Cargando experiencias...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-16">
          ...
          <div className="text-xl font-semibold text-white mb-4">Error cargando experiencias</div>
        ...
        <div className="text-center py-16">
          {searchTerm ? (
            <>
              ...
              <div className="text-xl text-white mb-2">No se encontraron experiencias</div>
            ...
            <>
              <div className="text-4xl mb-4">✨</div>
              <div className="text-xl text-white mb-2">Aún no tienes experiencias</div>
...
function ExperienceCard({ experience, viewMode }: ExperienceCardProps) {
  const assetTypes = [...new Set(experience.assets.map(asset => asset.assetType))];
  
  return (
    <Card className={`glass hover:bg-white/5 transition-all duration-200 ${
      ...
      <CardContent className={`pt-0 ${viewMode === 'list' ? 'flex items-center space-x-2' : 'space-y-2'}`}>

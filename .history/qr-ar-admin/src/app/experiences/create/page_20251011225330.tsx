...
export default function CreateExperiencePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For non-message assets, we need either a URL (uploaded file or direct URL) or a selected file
      ...
      // Create the asset based on type - THIS IS THE FIX
      const asset = {
      ...
      // Prepare experience data with assets array - FIXED STRUCTURE

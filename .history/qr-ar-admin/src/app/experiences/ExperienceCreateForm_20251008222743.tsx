...
import { CreateExperienceRequest, ARAsset, AssetType } from '@/types'
import { ApiClient } from '@/lib/api/client'
import { validateExperienceForm } from '@/lib/validations'
...
export function ExperienceCreateForm() {
  ...
  const validateForm = useCallback((): ValidationErrors => {
    ...
    if (!formData.qrCodeId.trim()) {
      newErrors.qrCodeId = 'El ID del código QR es requerido'
    }

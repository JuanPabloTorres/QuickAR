...
export default function ExperiencesPage() {
      ...
      try {
        ...
        if (response.success && response.data) {
          ...
          if (normalizedExperiences.length >= 5) {
            ...
            setNewAchievement({ 
              title: "🌟 En Camino", 
              description: "¡3 experiencias ya! Vas por buen camino hacia la maestría AR" 
            });
            setShowAchievement(true);
          }
        } else {
  ...
  return (
    <>
      ...
      <EasterEggProvider 
        onActivate={() => {
          setNewAchievement({ title: "🎮 Creative Hacker", description: "¡Código desbloqueado en el taller creativo!" });
          setShowAchievement(true);
        }}
      />
      <MotivationalQuote />

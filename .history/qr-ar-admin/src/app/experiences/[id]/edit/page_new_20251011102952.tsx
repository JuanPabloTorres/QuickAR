        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="glass">
            ...
            <CardContent className="space-y-6">
              ...
              {(formData.assetType === "model3d" || formData.assetType === "message") && (
                <div>
                  <label className="block text-sm font-medium text-blue-200 mb-2">
                    {formData.assetType === "message" ? "Contenido del Mensaje" : "Contenido del Modelo"}
                  </label>
                  <textarea
                    name="assetContent"
                    ...
                    rows={3}
                    className="w-full px-4 py-3 bg-gray-900/50 backdrop-blur-sm border border-gray-600/50 rounded-lg text-white placeholder-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 transition-all duration-200 hover:border-gray-500/70 resize-none"
                    placeholder={formData.assetType === "message" ? "Escribe tu mensaje aquí..." : "Configuración del modelo 3D..."}
                  />
                </div>
              )}

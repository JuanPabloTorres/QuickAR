  ...
  useEffect(() => {
    const loadExperience = async () => {
      ...
      try {
        ...
        let response = await getExperienceBySlug(experienceId);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-brand-950 to-qr-950 flex items-center justify-center">
        <div className="text-center text-white max-w-md mx-4">
          ...
          <div className="text-2xl font-semibold mb-4">Experiencia no disponible</div>
...
// We need to import this function - let me add it
async function getExperienceById(id: string) {
  const { getExperienceById: getById } = await import("@/lib/api/experiences");
  return getById(id);
}
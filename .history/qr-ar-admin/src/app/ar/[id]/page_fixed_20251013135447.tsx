...
export default function ARExperience() {
  ...
  const renderImageAsset = (
    ...
    ctx.fillText(asset.assetContent || "Image Asset", x, y + size * 0.4);
  };
  ...
  const renderTextAsset = (
    ...
    // Measure text
    const textWidth = ctx.measureText(asset.assetContent).width + 40 * scale;
            ...
            <div className="mb-6 p-4 bg-gray-800/50 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                ...
                >
                  ...
                  <span>{deviceCapabilities.isMobile ? "✓" : "Desktop"}</span>
                </div>
              </div>
            </div>

...
import { ArProvider, ArClient, useAR } from '@/components/ArClient'
import { ArOverlay, ArNotification } from '@/components/ArOverlay'
import { getPrimaryAsset, hasARCapabilities } from '@/lib/experience-helpers'
...
function ARExperienceContent({
  ...
  useEffect(() => {
    ...
    if (selectedAssetId) {
      initialAsset = arAssets.find(asset => asset.id === selectedAssetId) || null
    }
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-8">
          ...
          <p className="text-gray-600">
            Preparando los modelos 3D para AR
          </p>
        </div>
      </div>
    )
          ...
          <div className="absolute bottom-safe-area left-4 right-4 z-20">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
              ...
              <div className="flex items-center justify-between mt-3 text-sm text-white/60">
                ...
                <span>{arAssets.length} modelo{arAssets.length !== 1 ? 's' : ''}</span>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm mb-6">
                Toca el botón "Ver en AR" para iniciar la experiencia de Realidad Aumentada.
      ...
      {!isARSupported && mode === 'ar' && (
        <div className="absolute inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full text-center">
            ...
            <p className="text-gray-600 text-sm mb-6">
              Tu dispositivo no soporta Realidad Aumentada. Puedes ver el modelo 3D en modo vista previa.
            </p>

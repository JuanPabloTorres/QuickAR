        ...
        <div className="space-y-6">
          ...
          <FuturisticCard variant="glass" glow>
            ...
            <FuturisticCardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300 font-manrope">Experiencias creadas</span>
                <span className="font-orbitron text-white font-bold">24</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300 font-manrope">Tiempo en línea</span>
                <span className="font-orbitron text-white font-bold">47h</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-slate-300 font-manrope">Último acceso</span>
          ...
          <FuturisticCard variant="neon">
            ...
            <FuturisticCardContent className="space-y-3">
              <FuturisticButton variant="outline" className="w-full justify-start">

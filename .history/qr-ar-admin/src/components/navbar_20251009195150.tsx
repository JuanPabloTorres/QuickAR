...
export function Navbar() {
  ...
  return (
    <nav className="relative bg-black/20 backdrop-blur-xl border-b border-white/10 sticky top-0 z-50">
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <IconComponent className={`h-4 w-4 transition-all duration-300 ${isActive ? "text-sky-400" : "group-hover:scale-110"}`} />

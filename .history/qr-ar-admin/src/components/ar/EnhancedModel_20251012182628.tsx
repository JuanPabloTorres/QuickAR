...
// Dynamic imports for React Three Fiber hooks to avoid SSR issues
const useFrame = dynamic(() => import('@react-three/fiber').then(mod => ({ default: mod.useFrame })), {
  ssr: false
}) as any;

const useLoader = dynamic(() => import('@react-three/fiber').then(mod => ({ default: mod.useLoader })), {
  ssr: false
}) as any;

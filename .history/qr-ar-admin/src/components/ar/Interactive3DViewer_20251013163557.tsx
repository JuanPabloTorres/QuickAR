          ...
          case "message": {
            ...
            if (asset.assetContent) {
              ...
              if (context) {
                ...
                context.quadraticCurveTo(padding + innerWidth, padding, padding + innerWidth, padding + radius);
                context.lineTo(padding + innerWidth, padding + innerHeight - radius);
                context.quadraticCurveTo(padding + innerWidth, padding + innerHeight, padding + innerWidth - radius, padding + innerHeight);
                context.lineTo(padding + radius, padding + innerHeight);
                context.quadraticCurveTo(padding, padding + innerHeight, padding, padding + innerHeight - radius);

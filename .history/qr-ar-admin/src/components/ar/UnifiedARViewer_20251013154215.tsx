...
// Dynamically import Desktop3DViewer with SSR disabled to prevent React Three Fiber errors
const Desktop3DViewer = dynamic(() => import("./Desktop3DViewer"), {
  ssr: false,
  loading: () => (
    <div className="flex h-screen items-center justify-center">
      <div className="text-center">
        ...
        <p className="text-gray-600">Cargando visor 3D...</p>
      </div>
    </div>
  ),
});

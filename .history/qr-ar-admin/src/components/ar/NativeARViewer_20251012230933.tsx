...
export default function NativeARViewer({
  ...
  const renderImageInAR = (view: XRView, asset: Asset) => {
    ...
    const quadVertices = new Float32Array([
      -0.2, -0.15, 0, 0.2, -0.15, 0, 0.2, 0.15, 0, -0.2, 0.15, 0,
    ]);
  ...
  const renderVideoInAR = (view: XRView, asset: Asset) => {
    ...
    const quadVertices = new Float32Array([
      -0.25, -0.15, 0, 0.25, -0.15, 0, 0.25, 0.15, 0, -0.25, 0.15, 0,
    ]);
          ...
          {isARSupported ? (
            <div>
              ...
              <div className="mt-4 text-sm text-gray-500">
                <p>Tipo de contenido: {asset.assetType}</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Tu dispositivo no soporta WebXR AR o necesita un navegador
                compatible.
              </p>
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm">
                ...
                <ul className="text-yellow-700 space-y-1">
                  <li>
                    • Un dispositivo móvil compatible (Android con ARCore)
                  </li>

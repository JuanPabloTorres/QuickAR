        ...
        <div className="relative w-64 h-64 sm:w-80 sm:h-80">
          ...
          <div className="relative w-full h-full">
            ...
            <div className="absolute inset-0 pointer-events-none">
              ...
              <div className="absolute w-full h-0.5 bg-gradient-to-r from-transparent via-green-400 to-transparent animate-pulse top-1/2 opacity-60" 
                   style={{ animationDelay: '0.5s' }} />
              <div className="absolute w-full h-0.5 bg-gradient-to-r from-transparent via-purple-400 to-transparent animate-pulse top-3/4 opacity-40"

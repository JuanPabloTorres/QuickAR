...
const CameraViewer: React.FC<CameraViewerProps> = ({
  ...
  return (
    <div className="ar-fullscreen" role="application" aria-label="Modo cámara AR">
          ...
          <div className="ar-content-wrapper">
            ...
            {asset.kind === 'video' && (
              <video
                ...
                onLoadedData={() => onTrackEvent('overlay_video_load', asset.id)}
      ...
      <div className="ar-footer" style={{ pointerEvents: 'none' }}>
        <div className="ar-footer-content" style={{ pointerEvents: 'auto' }}>
          <button
            ...
            aria-label={overlayVisible ? 'Ocultar contenido' : 'Mostrar contenido'}
          >

      ...
      <div className="relative">
        ...
        >
          ...
          {experience.assets.slice(1, 5).map((asset, index) => (
            <div
              key={asset.id}
              className={`cube-face absolute w-64 h-64 sm:w-80 sm:h-80 backdrop-blur-md flex items-center justify-center cursor-pointer border border-white/10 transition-all duration-300 ${

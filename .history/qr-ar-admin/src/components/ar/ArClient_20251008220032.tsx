    ...
    const checkARSupport = async () => {
      try {
        if (typeof window === 'undefined') {
          setARState(prev => ({ ...prev, isLoading: false, isARSupported: false }));
          return;
        }
        ...
        const hasModelViewer = typeof window !== 'undefined' && 
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-white text-lg font-medium mb-2">Inicializando AR...</h2>

...
import type { Html as HtmlType, useTexture as useTextureType, useVideoTexture as useVideoTextureType } from "@react-three/drei";
import type { useFrame as useFrameType, useLoader as useLoaderType } from "@react-three/fiber";
...
let GLTFLoader: typeof GLTFLoaderType;

    ...
    >
      ...
      {arScanActive && (
        <div className="absolute inset-0 pointer-events-none z-10">
          <div className="w-full h-full border border-sky-400/30 relative">
            {/* Scanning lines */}
            <div
              className={`absolute w-full h-0.5 bg-gradient-to-r from-transparent via-sky-400 to-transparent animate-pulse ${
                glitchEffect ? "opacity-100" : "opacity-60"
              }`}
            ...
            <div
              className={`absolute w-full h-0.5 bg-gradient-to-r from-transparent via-green-400 to-transparent animate-pulse ${
                glitchEffect ? "opacity-60" : "opacity-100"
              }`}
              style={{
                top: "50%",
            ...
            <div
              className={`absolute w-full h-0.5 bg-gradient-to-r from-transparent via-purple-400 to-transparent animate-pulse ${
                glitchEffect ? "opacity-100" : "opacity-40"
              }`}
              style={{
                top: "75%",
      ...
      <div className="relative">
        ...
        >
          ...
          <div
            className={`cube-face absolute w-64 h-64 sm:w-80 sm:h-80 backdrop-blur-md flex items-center justify-center border border-white/10 ${
              isHovered
                ? "bg-gradient-to-br from-sky-500/20 via-purple-500/15 to-green-500/20"
                : "bg-gradient-to-br from-sky-900/30 via-purple-900/20 to-green-900/30"
            } transition-all duration-500`}
            style={{
              transform: "translateZ(112px)",
              boxShadow: isHovered
                ? "0 0 40px rgba(56, 189, 248, 0.3), inset 0 0 40px rgba(168, 85, 247, 0.1)"
                : "none",
            }}
          >
            <div className="w-56 h-56 sm:w-72 sm:h-72 relative">
              ...
              <div className="absolute inset-0 border-2 border-sky-400/40 rounded-lg">
                <div className="absolute top-1 left-1 sm:top-2 sm:left-2 w-3 h-3 sm:w-4 sm:h-4 border-t-2 border-l-2 border-sky-400" />
                <div className="absolute top-1 right-1 sm:top-2 sm:right-2 w-3 h-3 sm:w-4 sm:h-4 border-t-2 border-r-2 border-sky-400" />
                <div className="absolute bottom-1 left-1 sm:bottom-2 sm:left-2 w-3 h-3 sm:w-4 sm:h-4 border-b-2 border-l-2 border-sky-400" />
                <div className="absolute bottom-1 right-1 sm:bottom-2 sm:right-2 w-3 h-3 sm:w-4 sm:h-4 border-b-2 border-r-2 border-sky-400" />
              </div>
            </div>
          </div>

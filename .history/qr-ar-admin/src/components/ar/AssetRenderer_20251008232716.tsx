/**
 * AssetRenderer - Renderiza diferentes tipos de assets AR
 * 
...
function TextAsset({ asset, onLoad, onInteraction }: AssetComponentProps) {
  ...
  return (
    <div
      className="bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg p-4 shadow-lg cursor-pointer hover:bg-white/95 transition-colors"

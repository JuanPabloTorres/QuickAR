...
interface CanvasComponent extends React.ComponentType<any> {}
interface OrbitControlsComponent extends React.ComponentType<any> {}

type ThreeFiberComponents = {
  Canvas: CanvasComponent | null;

...
import { resolveAssetUrl as resolveAssetUrlAsync, getFallbackAssetUrl, createBlobUrlFromServer } from "@/lib/enhancedAssetResolver";
      ...
      try {
        ...
        if (result.isValid) {
          ...
          if (fallbackUrl) {
            ...
            throw new Error(result.error || "No se pudo resolver la URL del asset");
          }
        }
      } catch (err) {
        const errorMsg =

...
export default function ARExperienceCanvas({
  ...
  const [currentMode, setCurrentMode] = useState<"preview" | "ar" | "fallback">(
    "preview"
  );
  ...
  useEffect(() => {
    const checkARCapabilities = async () => {
      ...
      onPerformanceChange?.({
        fps: 60,
        status: `WebXR AR: ${capabilities.webxrAR ? "✅" : "❌"} | WebXR VR: ${
          capabilities.webxrVR ? "✅" : "❌"
        } | Session: ${currentMode}`,
      });
          ...
          <div className="flex flex-wrap gap-3 items-center">
            ...
            {isARSupported ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-gray-400 text-xs">AR no disponible</div>
              </div>
            )}

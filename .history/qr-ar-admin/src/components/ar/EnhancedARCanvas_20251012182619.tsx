...
const Canvas = dynamic(() => import('@react-three/fiber').then(mod => ({ default: mod.Canvas })), {
  ssr: false,
  loading: () => <div className="w-full h-full bg-gradient-to-br from-slate-950 to-blue-950 animate-pulse flex items-center justify-center text-white">
...
const PerformanceMonitor = dynamic(() => import('@react-three/drei').then(mod => ({ default: mod.PerformanceMonitor })), {
  ssr: false
});

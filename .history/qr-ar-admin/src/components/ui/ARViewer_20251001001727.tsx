...
const SimpleARViewer: React.FC<{
  ...
  // Helper function for generating transform styles
  const getTransformStyle = (): React.CSSProperties => ({
    transform: `translate(${gestures.position.x}px, ${gestures.position.y}px) scale(${gestures.scale}) rotate(${gestures.rotation}deg)`,

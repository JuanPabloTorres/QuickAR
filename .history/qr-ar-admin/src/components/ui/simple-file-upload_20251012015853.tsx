...
export default function SimpleFileUpload({
  ...
  const handleUpload = async () => {
    ...
    try {
      const result = await SimpleUploadService.uploadFile(selectedFile, assetType);
        ...
        >
          <div className="text-center">
            ...
            <p className="text-blue-200 font-medium">
              {selectedFile ? selectedFile.name : `Seleccionar ${getTypeLabel()}`}
            </p>
            ...
            {assetType === 'model3d' && (
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400">Modelo 3D seleccionado</p>
                </div>
              </div>
            )}
          </div>

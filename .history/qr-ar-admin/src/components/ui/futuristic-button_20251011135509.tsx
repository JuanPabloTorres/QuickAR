    ...
    return (
      <Comp
        className={cn(futuristicButtonVariants({ variant, size, className }), {
          "after:absolute after:inset-0 after:rounded-xl after:bg-gradient-to-r after:from-sky-500/30 after:via-indigo-500/30 after:to-purple-500/30 after:-z-10 after:blur-xl after:animate-pulse after:scale-110":
            glow,
          "animate-pulse": pulse,
          "relative before:absolute before:inset-0 before:bg-gradient-conic before:from-sky-400 before:via-purple-400 before:to-pink-400 before:rounded-xl before:blur-md before:-z-10 before:animate-spin before:duration-3000":
            hologram,
        })}
        ref={ref}
        {...props}

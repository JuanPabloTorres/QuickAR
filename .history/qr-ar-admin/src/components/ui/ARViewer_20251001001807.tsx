...
const SimpleARViewer: React.FC<{
  ...
  useEffect(() => {
    if (overlayRef.current) {
      ...
      element.style.setProperty('--gesture-rotation', `${gestures.rotation}deg`);
    }
  }, [gestures.position.x, gestures.position.y, gestures.scale, gestures.rotation]);
    ...
    <div className="ar-fullscreen">
      ...
      {overlayVisible && isVideoReady && !error && (
        <div className="ar-overlay">
          <div
            ref={overlayRef}
            className={`ar-content-wrapper ar-interactive ar-interactive-dynamic ${isAnimating ? "ar-bouncing" : ""} ${

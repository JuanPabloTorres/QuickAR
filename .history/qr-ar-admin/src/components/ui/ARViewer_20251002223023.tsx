  ...
  const renderARButton = () => {
    ...
    const getButtonConfig = () => {
      switch (asset.kind) {
        case "model3d":
          return {
            icon: getARIcon("model3d", { size: 20, className: "text-white" }),
            text: "Ver en AR 3D",
            className: "ar-btn-primary",
          };
        case "image":
          return {
            icon: getARIcon("image", { size: 20, className: "text-white" }),
            text: "Ver en AR",
            className: "ar-btn-purple",
          };
        case "video":
          return {
            icon: getARIcon("video", { size: 20, className: "text-white" }),
            text: "Ver Video AR",
            className: "ar-btn-green",
          };
        case "message":
          return {
            icon: getARIcon("message", { size: 20, className: "text-white" }), // Modern message bubble icon
            text: "Ver Mensaje AR",
    ...
    return (
      ...
      >
        <span className="ar-btn-icon flex items-center justify-center">
          {buttonConfig.icon}
        </span>
        {buttonConfig.text}
      </button>

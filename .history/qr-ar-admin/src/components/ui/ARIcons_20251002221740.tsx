...
export const ARCubeIcon: React.FC<{ className?: string }> = ({
  className = "",
}) => (
  <svg
    width="24"
  ...
  >
    ...
    {/* 3D Cube */}
    <path
      d="M32 20L44 26V38L32 44L20 38V26L32 20Z"
      fill="currentColor"
      opacity="0.3"
    />
    <path
      d="M32 20L44 26L32 32L20 26L32 20Z"
      fill="currentColor"
      opacity="0.9"
    />
...
// Video Play SVG Icon
export const VideoIcon: React.FC<{ className?: string }> = ({
  className = "",
}) => (
  <svg
    width="24"
...
export const MessageIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      d="M21 11.5C21 16.75 16.75 21 11.5 21C10.22 21 8.98 20.69 7.88 20.12L3 21L4.13 16.88C3.31 15.44 2.75 13.78 2.75 12C2.75 6.75 7 2.5 12.25 2.5C17.5 2.5 21 6.75 21 11.5Z"
      stroke="currentColor"
      strokeWidth="2"
      fill="none"
    />

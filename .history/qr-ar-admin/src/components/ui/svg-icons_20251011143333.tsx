...
export function TrophyIcon({
  ...
  return (
    ...
    >
      ...
      {/* Trophy base */}
      <rect x="8" y="18" width="8" height="3" rx="1" fill="url(#trophyGradient)" />
      <rect x="9" y="16" width="6" height="3" rx="1" fill="url(#trophyGradient)" opacity="0.8" />
      {/* Trophy cup */}
      <path 
      ...
      />
      {/* Trophy handles */}
      <path d="M5 8C4 8 3 9 3 10C3 11 4 12 5 12V8Z" fill="url(#trophyGradient)" opacity="0.7" />
      <path d="M19 8C20 8 21 9 21 10C21 11 20 12 19 12V8Z" fill="url(#trophyGradient)" opacity="0.7" />
      {/* AR glow effect */}
...
export function RocketIcon({
  ...
  return (
    ...
    >
      ...
      {/* Rocket fins */}
      <path d="M8 12L10 14V16L8 14V12Z" fill="url(#rocketGradient)" opacity="0.7" />
      <path d="M16 12L14 14V16L16 14V12Z" fill="url(#rocketGradient)" opacity="0.7" />
      {/* Exhaust flames */}
...
export function PackageIcon({
  ...
  return (
    ...
    >
      ...
      {/* Box base */}
      <path d="M4 8L12 4L20 8V16L12 20L4 16V8Z" fill="url(#packageGradient1)" opacity="0.8" />
      {/* Box top face */}
      <path d="M4 8L12 4L20 8L12 12L4 8Z" fill="url(#packageGradient2)" />
      {/* Box right face */}
      <path d="M12 12L20 8V16L12 20V12Z" fill="url(#packageGradient1)" opacity="0.6" />
      {/* Box dividing lines */}
      <path d="M4 8L12 12V20" stroke="#FFFFFF" strokeWidth="0.5" opacity="0.8" />
...
export function CelebrationIcon({
  ...
  return (
    ...
    >
      ...
      {/* Main burst center */}
      <circle cx="12" cy="12" r="3" fill="url(#celebrationGradient)" opacity="0.8" />
      <circle cx="12" cy="12" r="1.5" fill="#FFFFFF" opacity="0.9" />
      {/* Burst rays */}
      ...
      {/* Confetti particles */}
      <rect x="6" y="4" width="1" height="2" rx="0.5" fill="#FFD700" transform="rotate(45 6.5 5)" />
      <rect x="17" y="6" width="1" height="2" rx="0.5" fill="#FF6B35" transform="rotate(-30 17.5 7)" />
      <rect x="18" y="16" width="1" height="2" rx="0.5" fill="#8B5CF6" transform="rotate(60 18.5 17)" />
      <rect x="5" y="17" width="1" height="2" rx="0.5" fill="#3DD8B6" transform="rotate(-45 5.5 18)" />
    </svg>
  );
}
...
export function CheckIcon({
  ...
  return (
    ...
    >
      ...
      <circle cx="12" cy="12" r="9" stroke="url(#checkGradient)" strokeWidth="1" opacity="0.4" />
      {/* Check mark */}
      <path 
        d="M8 12L11 15L16 9" 

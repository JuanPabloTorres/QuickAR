      ...
      <div
        ...
        className={cn(
          ...
          // Variants
          {
            ...
            // Enhanced glass
            "bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border-white/20 shadow-2xl":
              variant === "glass",

            // Neon effect
            "bg-slate-900/90 backdrop-blur-md border border-sky-500/30 shadow-lg shadow-sky-500/20":
              variant === "neon",

            // Dark mode
            "bg-slate-900/80 backdrop-blur-md border-slate-700/50 shadow-xl":
              variant === "dark",
          },
          ...
          // Hover effects
          {
            ...
            "hover:bg-white/15 hover:border-white/40 hover:shadow-3xl hover:scale-[1.02]":
              hover && variant === "glass",
            "hover:border-sky-500/50 hover:shadow-sky-500/30 hover:shadow-xl hover:scale-[1.02]":
              hover && variant === "neon",
            "hover:bg-slate-900/90 hover:border-slate-600/70 hover:shadow-2xl hover:scale-[1.02]":
              hover && variant === "dark",
          },

          // Glow effect
          {
            "before:absolute before:inset-0 before:rounded-xl before:bg-gradient-to-r before:from-sky-500/20 before:to-indigo-500/20 before:-z-10 before:blur-xl":
              glow,
          },

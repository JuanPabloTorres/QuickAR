    ...
    return (
      <Comp
        className={cn(futuristicButtonVariants({ variant, size, className }), {
          "relative before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-r before:from-sky-500/20 before:to-indigo-500/20 before:-z-10 before:blur-lg before:animate-pulse":
            glow,
        })}
        ref={ref}
        {...props}

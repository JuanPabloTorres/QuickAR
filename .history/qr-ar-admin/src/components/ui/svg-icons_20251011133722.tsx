...
export function HomeIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M12 2L22 12H19V10L12 4L5 10V12H2L12 2Z"
        fill={color}
      />
      {/* AR overlay effect */}
...
export function PlusIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Outer glow */}
      <rect x="10" y="4" width="4" height="16" rx="2" fill="url(#plusGradient)" opacity="0.3" />
      <rect x="4" y="10" width="16" height="4" rx="2" fill="url(#plusGradient)" opacity="0.3" />
      {/* Main cross */}
      <rect x="11" y="5" width="2" height="14" rx="1" fill="url(#plusGradient)" />
      <rect x="5" y="11" width="14" height="2" rx="1" fill="url(#plusGradient)" />
      {/* Center dot */}
...
export function SparklesIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AnalyticsIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M14 14L15.5 12.5L18.5 12.5L17 14Z" fill="#3DD8B6" opacity="0.7" />
...
export function SettingsIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Diagonal teeth */}
      <rect x="5.5" y="5.5" width="1.4" height="1.4" fill="#00D4FF" transform="rotate(45 6.2 6.2)" />
      <rect x="17.1" y="5.5" width="1.4" height="1.4" fill="#00D4FF" transform="rotate(45 17.8 6.2)" />
      <rect x="5.5" y="17.1" width="1.4" height="1.4" fill="#00D4FF" transform="rotate(45 6.2 17.8)" />
      <rect x="17.1" y="17.1" width="1.4" height="1.4" fill="#00D4FF" transform="rotate(45 17.8 17.8)" />
...
export function MenuIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="3" y="5" width="18" height="0.5" rx="0.25" fill="#ffffff" opacity="0.5" />
      
      <rect x="3" y="11" width="18" height="2" rx="1" fill="url(#menuGradient)" />
      <rect x="3" y="11" width="18" height="0.5" rx="0.25" fill="#ffffff" opacity="0.5" />
      
      <rect x="3" y="17" width="18" height="2" rx="1" fill="url(#menuGradient)" />
      <rect x="3" y="17" width="18" height="0.5" rx="0.25" fill="#ffffff" opacity="0.5" />
...
export function UserIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* AR halo */}
      <circle cx="12" cy="12" r="10" fill="none" stroke="#3DD8B6" strokeWidth="0.5" opacity="0.3" />
      <circle cx="12" cy="12" r="8" fill="none" stroke="#00D4FF" strokeWidth="0.5" opacity="0.5" />
      ...
      {/* Data streams */}
      <rect x="1" y="9" width="3" height="0.5" rx="0.25" fill="#3DD8B6" opacity="0.4" />
      <rect x="20" y="11" width="3" height="0.5" rx="0.25" fill="#00D4FF" opacity="0.4" />
      <rect x="2" y="15" width="2" height="0.5" rx="0.25" fill="#8B5CF6" opacity="0.4" />
    </svg>
  );
}

// Eye Icon - AR Vision with scanning effect
export function EyeIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Scanning grid */}
      <rect x="10" y="10" width="4" height="4" fill="none" stroke="#00D4FF" strokeWidth="0.3" opacity="0.4" />
      {/* Corner markers */}
      <rect x="6" y="8" width="2" height="0.5" fill="#3DD8B6" opacity="0.6" />
      <rect x="16" y="8" width="2" height="0.5" fill="#3DD8B6" opacity="0.6" />
      <rect x="6" y="15.5" width="2" height="0.5" fill="#3DD8B6" opacity="0.6" />
      <rect x="16" y="15.5" width="2" height="0.5" fill="#3DD8B6" opacity="0.6" />
    </svg>
  );
}

// QR Code Icon - Stylized with AR elements
export function QrCodeIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* AR scanning effect */}
      <rect x="10" y="10" width="4" height="4" fill="none" stroke="#00D4FF" strokeWidth="0.5" opacity="0.6" />
...
export function LogoutIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Door frame */}
      <rect x="3" y="4" width="10" height="16" rx="2" fill="#1a1a2e" stroke="url(#logoutGradient)" strokeWidth="1" />
      {/* Door */}
      <rect x="4" y="5" width="8" height="14" rx="1" fill="url(#logoutGradient)" opacity="0.8" />
      {/* Door handle */}
      <circle cx="10" cy="12" r="0.8" fill="#ffffff" opacity="0.9" />
      {/* Exit arrow */}
      <path d="M15 12L19 12M19 12L17 10M19 12L17 14" stroke="#3DD8B6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      {/* AR exit indicators */}
      <rect x="21" y="10" width="2" height="0.5" fill="#3DD8B6" opacity="0.6" />
      <rect x="21" y="11" width="1.5" height="0.5" fill="#00D4FF" opacity="0.6" />
      <rect x="21" y="12.5" width="2" height="0.5" fill="#3DD8B6" opacity="0.6" />
      <rect x="21" y="13.5" width="1.5" height="0.5" fill="#00D4FF" opacity="0.6" />
    </svg>
  );
}

// X/Close Icon - Holographic cross
export function CloseIcon({ className = "", size = 24, color = "currentColor" }: SvgIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      {/* Glow effect */}
      <path d="M6 6L18 18M18 6L6 18" stroke="url(#closeGradient)" strokeWidth="3" strokeLinecap="round" opacity="0.3" />
      {/* Main cross */}
      <path d="M6 6L18 18M18 6L6 18" stroke="url(#closeGradient)" strokeWidth="2" strokeLinecap="round" />
      {/* Center intersection */}
      <circle cx="12" cy="12" r="2" fill="none" stroke="#ffffff" strokeWidth="0.5" opacity="0.6" />
    </svg>
  );
}

            ...
            {showInstructions && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                ...
                <ul className="text-xs text-blue-800 space-y-1">
                  <li>
                    • Mueve lentamente tu dispositivo para encontrar una
                    superficie
                  </li>
              ...
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  ...
                  {activeAsset.fileSizeBytes && (
                    <div className="flex justify-between">
                      <span>Tamaño:</span>
                      <span>{formatBytes(activeAsset.fileSizeBytes)}</span>
                    </div>
                  )}
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full max-h-96 overflow-y-auto">
            ...
            <div className="space-y-4 text-sm text-gray-700">
              <div>
                ...
                <p>
                  Mueve tu dispositivo lentamente hasta que aparezca un
                  indicador en tu pantalla. Toca donde quieras colocar el
                  objeto.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  <li>
                    • <strong>Toque simple:</strong> Seleccionar/colocar objeto
                  </li>
                  <li>
                    • <strong>Arrastrar:</strong> Mover objeto por la superficie
                  </li>
                  <li>
                    • <strong>Pellizcar:</strong> Cambiar tamaño
                  </li>
                  <li>
                    • <strong>Rotar con dos dedos:</strong> Girar objeto
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  <li>
                    • <strong>No detecta superficie:</strong> Mejora la
                    iluminación
                  </li>
                  <li>
                    • <strong>Objeto desaparece:</strong> Regresa a la
                    superficie original
                  </li>
                  <li>
                    • <strong>Lag o lentitud:</strong> Cierra otras apps
                  </li>
                </ul>
              </div>
            </div>

...
const nextConfig = {
  ...
  // Disable tracing completely to avoid permission issues
        ...
        headers: [
          {
            ...
            value:
              "camera=*, microphone=*, gyroscope=*, accelerometer=*, xr-spatial-tracking=*",
          },
          {
            key: "Feature-Policy",
            value:
              "xr-spatial-tracking 'self'; camera 'self'; microphone 'self'; gyroscope 'self'; accelerometer 'self'",
          },
        ],
      },
    ];
